...
List<PopupMenuEntry<String>> _buildSongMenuItems({
  ...
  final startRadioText =
      (l10n as dynamic).startRadio as String? ?? 'Start radio';
  ...
  switch (value) {
    case 'start_radio':
      if (song is Map) {
        ...
        final radioStartedText =
            (context.l10n as dynamic).radioStarted as String? ??
