...
import 'package:sv_music/utilities/listening_stats_utils.dart';
import 'package:sv_music/widgets/announcement_box.dart';
import 'package:sv_music/widgets/listening_recap_card.dart';
import 'package:sv_music/widgets/mini_player_bottom_space.dart';
import 'package:sv_music/widgets/playlist_cube.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('SV Music')),
