...
import 'package:sv_music/screens/search_page.dart';
import 'package:sv_music/services/common_services.dart';
import 'package:sv_music/services/data_manager.dart';
import 'package:sv_music/services/listening_stats_service.dart';
...
import 'package:sv_music/theme/app_colors.dart';
import 'package:sv_music/theme/app_themes.dart';
import 'package:sv_music/utilities/flutter_bottom_sheet.dart';
import 'package:sv_music/utilities/flutter_toast.dart';
import 'package:sv_music/utilities/language_utils.dart';
import 'package:sv_music/widgets/bottom_sheet_bar.dart';
import 'package:sv_music/widgets/confirmation_dialog.dart';
import 'package:sv_music/widgets/custom_bar.dart';
...
class SettingsPage extends StatelessWidget {
        ...
        itemBuilder: (context, index) {
          ...
          return BottomSheetBar(
            ...
            () {
              ...
              SvMusic.updateAppState(context, newThemeMode: mode);
              Navigator.pop(context);
            },
            themeMode == mode,
      ...
      ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return BottomSheetBar(getLanguageDisplayName(context, language), () {
            ...
            SvMusic.updateAppState(context, newLocale: newLocale);
  ...
  void _togglePureBlack(BuildContext context, bool value) {
    ...
    SvMusic.updateAppState(context);
    showToast(context, context.l10n!.settingChangedMsg);
  }
