...
import 'package:sv_music/localization/app_localizations.dart';
import 'package:sv_music/services/audio_service.dart';
import 'package:sv_music/services/data_manager.dart';
import 'package:sv_music/services/io_service.dart';
import 'package:sv_music/services/listening_stats_service.dart';
import 'package:sv_music/services/logger_service.dart';
...
import 'package:sv_music/services/update_manager.dart';
...
import 'package:sv_music/utilities/sharing_intent.dart';
import 'package:path_provider/path_provider.dart';
import 'package:receive_sharing_intent/receive_sharing_intent.dart';

late SvMusicAudioHandler audioHandler;
...
class SvMusic extends StatefulWidget {
  const SvMusic({super.key});
  ...
  static Future<void> updateAppState(
    ...
    context.findAncestorStateOfType<_SvMusicState>()!.changeSettings(
  ...
  @override
  _SvMusicState createState() => _SvMusicState();
}

class _SvMusicState extends State<SvMusic> with WidgetsBindingObserver {
  void changeSettings({
    ThemeMode? newThemeMode,
    Locale? newLocale,
    Color? newAccentColor,
...
Future<void> initialisation() async {
  try {
    ...
    audioHandler = await AudioService.init(
      builder: SvMusicAudioHandler.new,
...
void handleIncomingLink(Uri? uri) async {
  if (uri == null || uri.scheme != 'svmusic' || uri.host != 'playlist') return;
